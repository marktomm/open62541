...
[[ -z ${GEN_OBJECT_FEEDER_MAN} ]] || {
    rm -v ${LCBC_ROOT}/bin/lcbcServer
    gcc --std=c99 ${OPEN_OPC_ROOT}/build/open62541.c ${LCBC_ROOT}/lcbcServer.c  ${LCBC_ROOT}/constants.c  ${LCBC_ROOT}/callbacks.c  ${LCBC_ROOT}/add.c ${LCBC_ROOT}/manual_lcbc_single.c -o ${LCBC_ROOT}/bin/lcbcServer
}
